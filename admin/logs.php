...
<head>
    ...
    <title>ประวัติการใช้งานแอดมิน</title>
        ...
        <div class="container mx-auto px-4 py-4 flex items-center justify-between">
            <div>
                <h1 class="text-xl font-bold text-gray-800">
                    <i class="fas fa-history text-blue-600"></i> ประวัติการใช้งานแอดมิน
                </h1>
                <p class="text-sm text-gray-500">ดูรายการการดำเนินการย้อนหลัง</p>
            </div>
    ...
    <main class="container mx-auto px-4 py-6">
        <div class="bg-white rounded-xl shadow-lg p-6 mb-4">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4">
                <div class="lg:col-span-2">
                    ...
                    <input type="text"
                           ...
                           placeholder="ชื่อผู้ใช้, คำอธิบาย, IP...">
                </div>
            ...
            <div class="mt-4 flex justify-end">
                <button id="admin-log-refresh-btn"
        ...
        <div id="admin-logs-loading" class="text-center py-12 bg-white rounded-xl shadow-lg">
            <div class="spinner-dark mx-auto mb-4"></div>
            <p class="text-gray-600">กำลังโหลดข้อมูล...</p>
        </div>

        <div id="admin-logs-content" class="hidden">
            <div class="bg-white rounded-xl shadow-lg overflow-hidden">
                    ...
                    <table class="w-full">
                        <thead class="bg-gradient-to-r from-blue-600 to-indigo-600 text-white">
                            <tr>
                                ...
                                <th class="px-4 py-3 text-left font-semibold">ผู้ใช้งาน</th>
                ...
                <div id="admin-logs-pagination" class="px-6 py-4 bg-gray-50 border-t border-gray-200"></div>
            </div>
        </div>
    </main>

    <script src="js/logs.js?v=<?php echo filemtime(__DIR__ . '/js/logs.js'); ?>"></script>
</body>
</html>
